        ...
        <nav class="bg-white px-2 sm:px-4 py-2.5 fixed w-full z-20 top-0 left-0 border-b border-gray-200">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
              <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-base md:font-medium md:border-0 md:bg-white">
                ...
                <li>
                  <a href="{{route('landingEmp')}}" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-roig md:p-0 md::hover:text-white">Página empresa</a>
                </li>
                <li>
                  <a href="{{route('perfilemp')}}" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-roig md:p-0 md::hover:text-white">Perfil empresa</a>
                </li>
                <li>
                  <a href="{{route('publicar')}}" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-roig md:p-0">Publicar Ofertas</a>
                </li>
                <li>
                  <a href="{{route('gestionar')}}" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-roig md:p-0">Gestionar Oferta</a>
                </li>
              </ul>
            </div>
            </div>
